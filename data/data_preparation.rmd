...
colnames(data_tidy_spreadout) <- c("Country","Year","FDI (in USD)","ElectricityAccess","Electric Power Consumption (kWh)","BankNonperformingLoans","BankCapitaltoAssetsRatio","BorrowersCommercialBank","DomesticCredittoPrivateSector","BankLiquidReservestoBankAssetsRatio","EaseofBusiness","Export of Goods and Services (% of GDP)", "AgraTotalValueAdded","ServiceValueAdded","IndustryValueAdded","AdjustedNetNationalIncome","GDPPerCapita","GDPPerCapitaPP","AdultLiteracy","Gini","EmployAgriculture","EmployIndustry","EmployService","Unemployment (% of total employment)","Death Rate (per thousand people)","Population (in millions)")
...
#############################################
plot2_selection <- data_tidy_spreadout.df[,c("Year","Country","GDPPerCapita","Unemployment","Population")]
...
#############################################
plot5_selection <- data_tidy_spreadout.df[,c("Year","Country","GDPPerCapita","Death Rate (per thousand people)","Electric Power Consumption (kWh)","Unemployment (% of total employment)","Population (in millions)","EaseofBusiness","Export of Goods and Services (% of GDP)","FDI (in USD)")]

plot5_tidyed <- tidyr::gather(plot5_selection, 'Series','Production',4:10)

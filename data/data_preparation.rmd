...
#############################################
plot5_selection <- data_tidy_spreadout.df[,c("Year","Country","GDPPerCapita","DeathRate","ElectricPowerConsumption","Unemployment","Population","EaseofBusiness","ExportGoodsServices","FDI")]

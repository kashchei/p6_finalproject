...
#############################################
plot5_selection <- data_tidy_spreadout.df[,c("Year","Country","GDP Per Capita","Death Rate (per thousand people)","Electric Power Consumption (kWh)","Unemployment (% of total employment)","Population (in millions)","Ease of Business","Export of Goods and Services (% of GDP)","FDI (in USD)")]
